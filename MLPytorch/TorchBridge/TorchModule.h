...
@interface DataScienceTorchModule : TorchModule

- (nullable NSArray<NSNumber*>*) predictData:(void*)csvDataBuffer shap:(nullable NSArray<NSNumber*>*) shapBuffer NS_SWIFT_NAME( predictHlstmModel(data:shap:) );
